...
<?php echo $this->Form->create('SofishObjectType');?>
	<fieldset>
		<legend><?php __('Edit Sofish Object Type'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('SofishObjectType.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('SofishObjectType.id'))); ?></li>
