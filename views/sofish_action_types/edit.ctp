...
<?php echo $this->Form->create('SofishActionType');?>
	<fieldset>
		<legend><?php __('Edit Sofish Action Type'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('SofishActionType.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('SofishActionType.id'))); ?></li>
